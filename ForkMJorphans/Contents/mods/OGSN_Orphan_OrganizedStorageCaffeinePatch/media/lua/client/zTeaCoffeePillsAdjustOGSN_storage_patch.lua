...
Adjust("GidOrganizedFood.OS4pkCoffee","DisplayName","Pack of Bulk Instant Coffee")

-- just in case
require("ItemTweaker_Copy_ogsn");
TweakItem("GidOrganizedFood.OS4pkCoffee","DisplayName","Pack of Bulk Instant Coffee");
