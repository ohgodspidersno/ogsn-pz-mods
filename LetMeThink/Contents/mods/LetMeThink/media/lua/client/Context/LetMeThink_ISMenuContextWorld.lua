...
--
-- local ISMenuContextWorld_new = ISMenuContextWorld.new
-- local ISMenuContextWorld_new_createMenu = ISMenuContextWorld.new.createMenu
--
-- function ISMenuContextWorld.new()
-- 	-- local self = ISMenuElement.new(); -- how to deal with this..?
-- 	context = ISMenuContextWorld_new()
--   function context.self.createMenu( _playerNum, _object, _objects, _x, _y, _test )
