...
if not string.find(versionNumber,"41.50") then
  ...
  local function isPuddleOrRiver(isoObject)
  ...
  --	end
  	...
  	if waterShutOff and props and props:Is(IsoFlagType.waterPiped) and not v:getUsesExternalWaterSource() and
