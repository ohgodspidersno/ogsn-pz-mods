...
ISWorldObjectContextMenu.createMenu = function(player, worldobjects, x, y, test)
  ...
  if (JoypadState.players[player + 1] or ISEmptyGraves.canDigHere(worldobjects)) and
  ...
  if getCore():isInDebug() then
    context:addOption("DBG: Stash Debug", worldobjects, ISWorldObjectContextMenu.onStashDebug);
    context:addOption("DBG: Teleport", worldobjects, ISWorldObjectContextMenu.onTeleport);
    context:addOption("DBG: Do Fatigue", worldobjects, ISWorldObjectContextMenu.onFatigue);
  end
...
ISWorldObjectContextMenu.onFatigue = function()
  getPlayer():getStats():setFatigue(1)
end
