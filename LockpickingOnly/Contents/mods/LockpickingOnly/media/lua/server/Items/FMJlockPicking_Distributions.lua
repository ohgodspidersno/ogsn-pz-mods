...
table.insert(SuburbsDistributions["all"]["shelves"].items, 0.2);
-- table.insert(SuburbsDistributions["shed"]["counter"].items, "FMJ.LockPickingMag");
-- table.insert(SuburbsDistributions["shed"]["counter"].items, 0.5);
-- table.insert(SuburbsDistributions["shed"]["counter"].items, "FMJ.LockPickingMag2");
-- table.insert(SuburbsDistributions["shed"]["counter"].items, 0.5);
-- table.insert(SuburbsDistributions["garagestorage"]["metal_shelves"].items, "FMJ.LockPickingMag");
-- table.insert(SuburbsDistributions["garagestorage"]["metal_shelves"].items, 0.2);
-- table.insert(SuburbsDistributions["garagestorage"]["metal_shelves"].items, "FMJ.LockPickingMag2");
-- table.insert(SuburbsDistributions["garagestorage"]["metal_shelves"].items, 0.2);
table.insert(SuburbsDistributions["bookstore"]["all"].items, "FMJ.LockPickingMag");
table.insert(SuburbsDistributions["bookstore"]["all"].items, 0.5);
table.insert(SuburbsDistributions["bookstore"]["all"].items, "FMJ.LockPickingMag2");
table.insert(SuburbsDistributions["bookstore"]["all"].items, 0.5);
...
-- table.insert(SuburbsDistributions["shed"]["counter"].items, "FMJ.BobbyPin");
-- table.insert(SuburbsDistributions["shed"]["counter"].items, 2.5);
